...
def loadEventsData (event_url, event_org):
    ...
    for x in range (2, row_len-33):
      ...
      for xpath in ['//*[@id="mw-content-text"]/div[1]/table[1]/tbody/tr[%i]/td[1]/a/text()',
                    '//*[@id="mw-content-text"]/div[1]/table[1]/tbody/tr[%i]/td[1]/i/a/text()',
                    '//*[@id="mw-content-text"]/div[1]/table[1]/tbody/tr[%i]/td[1]/i/text()']:
...
def countPastEvents(row_len, prev_row_ptr, array_pos):
    ...
    for loopid in range(0, row_len - 2):
        ...
        print('total past events to %i'%(bellator_pe))
        print('total upcoming events to %i'%(bellator_se))
        array_pos += 1
